...
%knn
X = importdata('matrisbirlestirme_smoothdatasiz.mat');
X = normalize(X);
...
save('KNN_smoothdatasiz.mat','all_accuracies');
save('Duyarlilik_smoothdatasiz.mat','duyarlilik');
save('Ozgulluk_smoothdatasiz.mat','ozgulluk');
save('SVM_smoothdatasiz.mat','acc_svm');
save('Duyarlilik_smoothdatasiz_SVM.mat', 'duyarlilik_svm');
save('Ozgulluk_smoothdatasiz_SVM.mat', 'ozgulluk_svm');